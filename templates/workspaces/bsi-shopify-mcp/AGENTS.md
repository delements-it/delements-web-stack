# AGENTS.md - BSI | Shopify MCP Workspace

## Role Lock

This workspace belongs to the `BSI | Shopify MCP` agent.

**Department:** Business Systems Integration
**Codex Room:** Shopify MCP

## Primary Purpose

Manage Shopify MCP server configuration, tool registration, and MCP protocol handling
...
- `brains/shopify_admin_bsi/BRAIN.md`
- `brains/shopify_admin_bsi/RULES.md`
