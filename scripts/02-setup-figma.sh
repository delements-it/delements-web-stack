...
FIGMA_MCP_DIR="${FIGMA_MCP_DIR:-$HOME/Documents/HH/figma-mcp-server}"
...
info "⚠️  Manual step: Add this plugin in Figma Desktop:"
...
echo ""
echo -e "${GREEN}✅ Figma MCP setup complete.${NC}"
echo "  MCP Server: $FIGMA_MCP_DIR/mcp"
echo "  Plugin:     $FIGMA_MCP_DIR/plugin"
echo "  Transport:  stdio"
echo "  ⚠️  Remember to open the plugin in Figma Desktop before using tools."
